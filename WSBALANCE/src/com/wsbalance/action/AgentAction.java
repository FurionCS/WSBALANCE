...
public class AgentAction extends ActionSupport implements SessionAware,ServletResponseAware{
	...
	public String getAgentByPage() throws IOException{
		if(!page.getStrWhere().equals("")){
			page.setStrWhere(" aglevel=0 and agstatus=1 and (agwxnum like '%"+page.getStrWhere()+"%' or agname like '%"+page.getStrWhere()+"%' or agtel like '%"+page.getStrWhere()+"%')");
		}else{
			page.setStrWhere(" aglevel=0 and agstatus=1");
		}
